...
import CalendarGrid from "@/components/dashboard/admin/jadwal-kegiatan/calender-grid"
    ...
    <main className="min-h-screen bg-background p-6 md:p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <h1 className="text-4xl font-bold text-foreground mb-2">Kalender Kegiatan</h1>
            <p className="text-muted-foreground">Kelola semua kegiatan dan rapat di satu tempat.</p>
          </div>
          <Button
          ...
          {view === "calendar" ? (
            <>
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <Button variant="outline" onClick={handleToday} className="text-sm bg-transparent">
                  Hari ini
                </Button>
              </div>
      ...
      <AddEventDialog open={showAddEvent} onOpenChange={setShowAddEvent} onAddEvent={handleAddEvent} />
    </main>
  )
}
